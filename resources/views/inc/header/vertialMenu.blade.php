<div class="d-none d-xl-block container">
    <div class="row">
                    ...
                    <div class="card border-0">
                        <div class="card-header card-collapse border-0" id="basicsHeadingOne">
                            <button type="button"
                                ...
                                data-bs-toggle="collapse" data-bs-target="#basicsCollapseOne" aria-expanded="true"
                        ...
                        <div id="basicsCollapseOne" class="collapse show vertical-menu"
                            ...
                            <div class="card-body p-0">
                                <nav
                                    class="js-mega-menu navbar navbar-expand-xl u-header__navbar u-header__navbar--no-space hs-menu-initialized hs-menu-horizontal hs-mobile-state">
                                    <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                        <ul class="navbar-nav u-header__navbar-nav">
                                            ...
                                            <li class="nav-item hs-has-mega-menu u-header__nav-item" data-event="hover"
                                                ...
                                                <!-- Nav Item - Mega Menu -->
                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                    aria-labelledby="basicMegaMenu1" style="display: none;">
                                                    <div class="vmm-bg">
                                            ...
                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                ...
                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu vmm-bg-extended"
                                                    aria-labelledby="basicMegaMenu2" style="display: none;">
                                                    <div class="vmm-bg">
                                            ...
                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                ...
                                                <!-- Nav Item - Mega Menu -->
                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                    aria-labelledby="basicMegaMenu3" style="display: none;">
                                                    <div class="vmm-bg">
                                            ...
                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                ...
                                                <a id="basicMegaMenu4"
                                                    class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                                    href="javascript:;" aria-haspopup="true" aria-expanded="false">TV
                                                    &amp; Audio</a>

                                                <!-- Nav Item - Mega Menu -->
                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                    aria-labelledby="basicMegaMenu4" style="display: none;">
                                                    <div class="vmm-bg">
                                            ...
                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                ...
                                                <!-- Nav Item - Mega Menu -->
                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                    aria-labelledby="basicMegaMenu5" style="display: none;">
                                                    <div class="vmm-bg">
        ...
        <!-- End Vertical Menu -->
        <!-- Secondary Menu -->
        @include('inc.header.secondaryMenu')
        <!-- End Secondary Menu -->
    </div>
</div>
